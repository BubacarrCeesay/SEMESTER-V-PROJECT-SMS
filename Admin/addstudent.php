...
if (isset($_POST["enroll"])) {
    ...
    $qc="select * from student where classId='$class' and divId='$div'";
    $rc=mysqli_query($con,$qc);

    while($rwc=mysqli_fetch_array($rc)){

      if(intval($rwc['rollno'])==$rollno){
        $_SESSION['update_success'] = "rollp";
            header("Location: addstudent.php");
            exit();
      }
    }

    $qy="INSERT INTO student(firstname, lastname, rollno, username, password, email, address, contact, dob, gender) VALUES ('$fname','$lname',$rollno,'$uname','$pswrd','$email','$address','$contact','$dob','$gender')";

    $rs = mysqli_query($con, $qy);

    $q="update student set classId='$class', divId='$div' where username='$uname' and password='$pswrd'";
  ...
  <body>
    ...
    <section class="frmup">
      ...
      <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
        ...
        <p class="sbtfrm">
          <input type="submit" value="Add Student" name="enroll" />
        </p>
  ...
  <script>
          ...
          function closeAlert() {
            ...
            if (isset($_SESSION['update_success']) && $_SESSION['update_success']=="inserted") {
                echo "showAlert('✅ Student Added Successfully!');";
            ...
            else if (isset($_SESSION['update_success']) && $_SESSION['update_success']=="rollp") {
