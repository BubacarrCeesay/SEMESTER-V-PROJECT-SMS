...
if(isset($_FILES['profpic']) && $_FILES['profpic']['error'] == 0){
  ...
  $qr="INSERT INTO teacher(firstname, lastname, email, address, username, password, contact, dob, gender, profile) VALUES ('$fname','$lname','$eml','$address','$uname','$pswrd','$contact','$dob','$gender','$prof')";

  $res=mysqli_query($con, $qr);

    if ($res) {
        $_SESSION['update_success'] = "inserted";
        move_uploaded_file($_FILES['profpic']['tmp_name'], "../Teacher/files/$prof");
    } else {
  ...
  $qr="INSERT INTO teacher(firstname, lastname, email, address, username, password, contact, dob, gender) VALUES ('$fname','$lname','$eml','$address','$uname','$pswrd','$contact','$dob','$gender')";
  ...
  <body>
    ...
    <main class="main">
      ...
      <form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" enctype="multipart/form-data">
        ...
        <p class="sbtfrm">
          <input type="submit" value="Add Teacher" name="add" />
        </p>
      </form>
    </main>
  </body>
  ...
  <script>
          ...
          function closeAlert() {
            ...
            if (isset($_SESSION['update_success']) && $_SESSION['update_success']=="inserted") {
                echo "showAlert('✅ Teacher Added Successfully!');";
