    ...
    if(mysqli_num_rows($result)>0){
        while($val=mysqli_fetch_array($result)){
            ...
            $output.="
                ...
                <a href='timetdirect.php?removeid=$eid'><button id='rej'>Delete<i class='fa-regular fa-rectangle-xmark'></i></button></a></td>
                </tr>
            ";
...
<body>
    ...
    <script>
        function downloadFile(fileId) {
            window.location.href = 'downloadtt.php?file_id=' + fileId;
        }
    </script>
</body>
</html>