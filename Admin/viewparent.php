    ...
    if(mysqli_num_rows($r) >0){
        while($rs= mysqli_fetch_array($r)){
            ...
            <td><a href='stuinfo.php?viewid=$stud'>$studen</a></td>
                    ...
                    <a href='prtredirect.php?removeid=$sid'><button id='rej'>Remove<i class='fa-regular fa-rectangle-xmark'></i></button></a></td>
            </tr>
            ";            
        }
  ...
  <script>
          ...
          function closeAlert() {
            ...
            if (isset($_SESSION['update_success']) && $_SESSION['update_success']=="notdeleted") {
                ...
                echo "showAlert('✅ Parent Deleted Successfully!');";
                unset($_SESSION['update_success']);
            }
