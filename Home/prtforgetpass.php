...
if(isset($_POST['reset']))
{
  ...
  if($password != $cpassword){
     $error['teacher']="⚠️ Both Password Does Not Match";
            ...
            $query="select * from parent where username='$username' and email='$email'";

            $result=mysqli_query($con, $query);

            if(mysqli_num_rows($result)==1){
                
                $sql="Update parent set password='$cpassword' where username='$username' and email='$email'";
  ...
  <body>
    ...
    <main>
      <section class="logup">
        ...
        <h3><a href="parentlogin.php" ><button>BACK TO LOGIN</button></a></h3>
