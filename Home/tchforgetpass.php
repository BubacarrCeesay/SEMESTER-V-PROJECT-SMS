...
if(isset($_POST['reset']))
{
  ...
  if($password != $cpassword){
     $error['teacher']="⚠️ Both Password Does Not Match";
            ...
            $query="select * from teacher where username='$username' and email='$email'";

            $result=mysqli_query($con, $query);

            if(mysqli_num_rows($result)==1){
                
                $sql="Update teacher set password='$cpassword' where username='$username' and email='$email'";
  ...
  <body>
    ...
    <main>
      <section class="logup">
        ...
        <h3><a href="teacherlogin.php" ><button>BACK TO LOGIN</button></a></h3>
