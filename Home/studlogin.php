...
if(isset($_POST['login']))
{
  ...
  if(mysqli_num_rows($result)==1){
    ...
    exit();
     $error['student']="✅ Login Successful";
  }
  else{
    $error['student']="⚠️ Invalid Username or Password";
  }

}
else{
    $error['student']="** All Fields Are Required **";
}
    ...
    <main>
      <section class="logup">
       ...
       <p><?php echo"$error[student]" ?></p>
        ...
        <h3><a href="studforgetpass.php" ><button>Forget Password</button></a></h3>
