...
if(isset($_FILES['prof']) && $_FILES['prof']['error'] == 0){
        ...
        $q = "UPDATE student SET username='$uname', firstname='$fname',lastname='$lname', profile='$prof',email='$email', address='$add', contact='$contact' WHERE username='$username'";
        ...
        $q = "UPDATE student SET username='$uname',firstname='$fname', lastname='$lname',email='$email', address='$add', contact='$contact' WHERE username='$username'";
