...
$sql="select * from mail where receiver='$tid' order by date DESC";
...
if(isset($_FILES['attch']) && $_FILES['attch']['error'] == 0){
  ...
  $qr="INSERT INTO mail(bya, sender, receiver, subject, message, date, attachment, status) VALUES ('teacher','$tid','$rec','$sub','$msg',NOW(),'$attch','notread')";
  ...
  $qr="INSERT INTO mail(bya, sender, receiver, subject, message, date,status) VALUES ('teacher','$tid','$rec','$sub','$msg',NOW(),'notread')";
