...
$sql="select * from mail where receiver='$pid' order by date DESC";
...
if(isset($_FILES['attch']) && $_FILES['attch']['error'] == 0){
  ...
  $qr="INSERT INTO mail(bya, sender, receiver, subject, message, date, attachment, status) VALUES ('parent','$pid','$rec','$sub','$msg',NOW(),'$attch','notread')";
  ...
  $qr="INSERT INTO mail(bya, sender, receiver, subject, message, date,status) VALUES ('parent','$pid','$rec','$sub','$msg',NOW(),'notread')";
...
<html lang="en">
  <head>
    ...
    <title>Parent | NoticeBoard</title>
